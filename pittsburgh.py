...
# root_dir = 'H:\\Dataset\\NetVLAD\\datasets\\Pittsburgh250k\\'
root_dir = '/home/titan/WSc/hmf/DATASET/Pittsburgh250k/'
...
class QueryDatasetFromStruct(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        with h5py.File(self.cache, mode='r') as h5: 
            ...
            # print(negSample.dtype)
            negSample = negSample.astype('int64')
